    ...
    <a class="group block rounded-xl overflow-hidden focus:outline-none" href="{{route('exibeNoticia', $noticia)}}">
      <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5">
        <div class="shrink-0 relative rounded-xl overflow-hidden w-full sm:w-56 h-44">
          <img class="group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out size-full absolute top-0 start-0 object-cover rounded-xl" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbf17PDzLxYrKJ6kQ_nFJYFcmJgsX5wMyiMQ&s" alt="Blog Image">
        </div>
